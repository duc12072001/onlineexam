						...
						<span id="error"></span>
				      	<div class="card">
				      		<form method="post" class="form-horizontal" action="" id="forget_password_form">
					      		<div class="card-header"><h3 class="text-center">Quên mật khẩu</h3></div>
					      		<div class="card-body">
				      			...
				      			<div class="card-footer text-center">
				      				...
				      				<p><input type="submit" name="submit" id="forget_password_button" class="btn btn-primary" value="Gửi" /></p>
