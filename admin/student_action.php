...
if(isset($_POST["action"]))
{
	...
	if($_POST["action"] == 'Add')
	{
		...
		{
			$error = '<div class="alert alert-danger">Học sinh đã tồn tại</div>';
		}
		else
		{
			$student_image = '';
			...
			$success = '<div class="alert alert-success">Đã thêm học sinh</div>';
		}
	...
	if($_POST["action"] == 'Edit')
	{
		...
		else
		{
			...
			$success = '<div class="alert alert-success">Đã cập nhật thông tin</div>';
	...
	if($_POST["action"] == 'change_status')
	{
		...
		echo '<div class="alert alert-success">Trạng thái học sinh sẽ chuyển sang '.$_POST['next_status'].'</div>';
	}
