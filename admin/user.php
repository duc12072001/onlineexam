    	...
    	<form method="post" id="user_form" enctype="multipart/form-data">
      		<div class="modal-content">
        		<div class="modal-header">
          			<h4 class="modal-title" id="modal_title">Thêm tài khoản</h4>
        		...
        		<div class="modal-body">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <label class="col-md-4 text-right">Tên tài khoản <span class="text-danger">*</span></label>
                            <div class="col-md-8">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <label class="col-md-4 text-right">SĐT <span class="text-danger">*</span></label>
                            <div class="col-md-8">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <label class="col-md-4 text-right">Profile</label>
                            <div class="col-md-8">
