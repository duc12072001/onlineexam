            ...
            <div class="col-sm-6 mt-5">
                ...
                <div class="card mt-5">
                    <form method="post" class="form-horizontal" id="login_form">
                        <div class="card-header"><h3 class="text-center">Đăng nhập</h3></div>
                        <div class="card-body">                   
                            ...
                            <div class="form-group">
                                <input type="password" name="user_password" id="user_password" class="form-control" required  data-parsley-trigger="keyup" placeholder="Mật khẩu" />
                            </div>
                        </div>
                        <div class="card-footer text-center">
                            <div class="form-group">
                                <button type="submit" name="login_button" id="login_button" class="btn btn-primary btn-user btn-block">Đăng nhập</button>
                            </div>
                        </div>
                    </form>
                </div>
