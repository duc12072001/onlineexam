...
if(isset($_POST["action"]))
{
	...
	if($_POST["action"] == 'Add')
	{
		...
		else
		{
			...
			$success = '<div class="alert alert-success">Đã thêm tài khoản</div>';
		}
	...
	if($_POST["action"] == 'delete')
	{
		...
		echo '<div class="alert alert-success">Trạng thái người dùng sẽ chuyển sang '.$_POST['next_status'].'</div>';
	}
