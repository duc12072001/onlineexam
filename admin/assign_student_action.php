...
if(isset($_POST["action"]))
{
	...
	if($_POST["action"] == 'Add')
	{
		...
		{
			$error = '<div class="alert alert-danger">Đã có</div>';
		}
		else
		{
			$data = array(
			...
			$success = '<div class="alert alert-success">Học sinh được phân vào lớp <b>'.$object->Get_class_name($_POST["class_id"]).'</b></div>';
		}
	...
	if($_POST["action"] == 'Edit')
	{
		...
		else
		{
			...
			$success = '<div class="alert alert-success">Đã cập nhật thông tin học sinh</div>';
		}
	...
	if($_POST["action"] == 'delete')
	{
		...
		echo '<div class="alert alert-success">Đã xoá học sinh</div>';
	}
