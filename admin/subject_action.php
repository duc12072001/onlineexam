...
if(isset($_POST["action"]))
{
	...
	if($_POST["action"] == 'Add')
	{
		...
		{
			$error = '<div class="alert alert-danger">Môn học đã tồn tại</div>';
		}
		else
		{
			$data = array(
			...
			$success = '<div class="alert alert-success">Đã thêm môn học</div>';
		}
	...
	if($_POST["action"] == 'Edit')
	{
		...
		$success = '<div class="alert alert-success">Đã cập nhật môn học</div>';
	...
	if($_POST["action"] == 'change_status')
	{
		...
		echo '<div class="alert alert-success">Trạng thái môn học sẽ chuyển sang '.$_POST['next_status'].'</div>';
	}
