            ...
            <li class="nav-item">
                ...
                <div id="subject_collapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar" style="">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="subject.php">Môn học</a>
                        <a class="collapse-item" href="assign_subject.php">Chỉ định môn học</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
                ...
                <div id="student_collapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar" style="">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="student.php">Học sinh</a>
                        <a class="collapse-item" href="assign_student.php">Chỉ định học sinh</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
                ...
                <div id="exam_collapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar" style="">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="exam.php">Bài thi</a>
                        <a class="collapse-item" href="exam_subject.php">Thuộc môn</a>
                        <a class="collapse-item" href="exam_subject_question.php">Câu hỏi</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
