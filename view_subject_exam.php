...
?>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-6">
                                <b>Đề : </b><?php echo $exam_title; ?>
                                </div>
                                <div class="col-md-6">
                                    <b>Môn : </b><?php echo $object->Get_Subject_name($subject_id); ?>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="card shadow">
                                        <div class="card-header"><b>Chi tiết học sinh</b></div>
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-4">
                                                ...
                                                <div class="col-md-8">
                                                    <b>STT : </b><?php echo $student_roll_no; ?><br />
                                                    <b>Tên : </b><?php echo $student_name; ?><br />
                                                    <b>Lớp : </b><?php echo $object->Get_class_name($class_id); ?>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
